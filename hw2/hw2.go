...
func main() {
	...
	var c Cart
	c.Items = []string{"milk", "chocolate"}

	fmt.Println("\nTest hasMilk() in cart items {'milk', 'chocolate'}")
	fmt.Println("Has milk: ", c.hasMilk())

	fmt.Println("\nTest hasItem() in cart items {'milk', 'chocolate'}")
	fmt.Println("Has chocolate: ", c.HasItem("chocolate"))
